...
public class DDSelectorView: UIView {
    ...
    private func addTableView() {
        ...
        tableView.register(DDSelectorCell.nib, forCellReuseIdentifier: DDSelectorCell.identifier)
...
extension DDSelectorView: UITableViewDataSource {
    public func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return itemList.count
    }
    
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: DDSelectorCell.identifier, for: indexPath) as? DDSelectorCell {
...
extension DDSelectorView : UITableViewDelegate {
